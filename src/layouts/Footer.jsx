export const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl text-center">
      ...
      <svg width="80" height="80" viewBox="0 0 512 512" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><g id="_x35_74_x2C__Cup_x2C__Coffee_x2C__Tea_x2C__Love"><g>
      ...
      <p className="my-6 text-gray-500 dark:text-gray-400">Replace fear of the unknown with curiosity. The Pursuit of Knowledge is an Endless Journey: Always Remember Your Initial Motivation.</p>
      <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
          ...
          <li>
              <a href="#education" className="mr-4 hover:underline md:mr-6">Educations</a>
          </li>
          <li>
              <a href="#organizations" className="mr-4 hover:underline md:mr-6">Organizations</a>
          </li>
          <li>
              <a href="#project" className="mr-4 hover:underline md:mr-6">Projects</a>
          </li>
          <li>
              <a href="#certifications" className="mr-4 hover:underline md:mr-6">Certifications</a>
          </li>
          <li>
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Isna Ayu M™</a>. All Rights Reserved.</span>
  </div>
</footer>
    </>
  )
